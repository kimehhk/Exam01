            ...
            case R.id.button:
                ...
                builder.setTitle("음식 추가")
                        ...
                        .setPositiveButton("추가", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int which) {
                                // 커스텀 대화상자의 내용 읽기
                                EditText etFood = (EditText)orderLayout.findViewById(R.id.etFood);
                                EditText etNation = (EditText)orderLayout.findViewById(R.id.etNation);
                                // 원본데이터 추가
                                foodManager.addFood(new Food(etFood.getText().toString(),etNation.getText().toString()));
                                // 화면 갱신
                                adapter.notifyDataSetChanged();
                            }
                        })
